...
namespace XianXia.Unit
{
    public class UIShowOrgan : OrganBase
    {
        ...
        public float MagicPer { get { if (magicOrgan == null||magicOrgan.MagicPoint_Max<=0) return -1; else return (float)magicOrgan.MagicPoint_Curr / (float)magicOrgan.MagicPoint_Max; } }
