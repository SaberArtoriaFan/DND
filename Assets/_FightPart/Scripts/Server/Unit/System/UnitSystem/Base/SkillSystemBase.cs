...
namespace XianXia.Unit
{
    ...
    public class SkillSystemBase<T> : SlightSystemBase<T, StatusOrganBase<T>>,ISkillSystem where T:SkillBase,new ()
    {
        ...
        internal T GainSkill(StatusOrganBase<T> magicOrgan,T skill) 
        {
            ...
            SystemUtility.StatusOrganAdd(magicOrgan, skill.GetType().ToString(), skill, LostSkill);
        ...
        internal T GainSkill(StatusOrganBase<T> t, string skillName)
        {
            ...
            if (o == null) { Debug.LogError("CANT Find SkillType,waht happened?"); return null; }
        ...
        internal void LostSkill(string name, object v)
        {
            ...
            T[] skills= SystemUtility.StatusOrganRemove<T>(name,bar, out bool res);
            if (res)
            {
                Debug.Log(name + "失去技能");
        ...
        internal void LostSkill(T skill)
        {
            ...
            SystemUtility.StatusOrganRemove(skill, out bool res);
            if (res)
                skill.LostSkill();
            //清理技能参数
            ClearPara(skill);
