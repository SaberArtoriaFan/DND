...
namespace Saber.ECS
{
    ...
    public class EntityBase:MonoBehaviour,IContainerEntity
    {
        ...
        //internal BoolContainer boolContainer = new BoolContainer();
        //public bool Enable { get => boolContainer.BoolValue; }
        ...
        {
            //ComponentBase[] values =;
            foreach (var organ in organDict.Values.ToArray())
            {
                if (organ != null)
                {
                    DestroyOrgan(organ);
